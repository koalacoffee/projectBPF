                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id" value="<?= $mahasiswa['id'];?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="prodi" id="prodi" class="form-control">
                                    <?php foreach($prodi as $p):?>
                                        <option value="<?= $p['id'];?>"  <?php if($mahasiswa['prodi'] == $p['id']) {echo "selected";}?>><?=$p['nama'];?></option>
                                    <?php endforeach;?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_hp"  value="<?= $mahasiswa['no_hp'];?>" class="form-control" id="no_hp" placeholder="Nomor HP">
